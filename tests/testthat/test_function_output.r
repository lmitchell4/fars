...
test_that("make_filename returns correct string", {  
  expect_match(string, make_filename(2013))
...
test_that("fars_read returns correct object type", {
  expect_is(fars_read(filename="accident_2013.csv.bz2"), ...)
})
...
test_that("fars_summarize_years returns correct object type", {
  expect_is(fars_summarize_years(years=2013:2015), ...)

})

test_that("fars_map_state returns correct object type", {
  expect_is(fars_map_state(state.num=1, year=2013), ...)
